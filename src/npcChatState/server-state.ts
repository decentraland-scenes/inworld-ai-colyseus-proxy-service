...
export class NpcState extends Schema implements serverStateSpec.NpcState {
...
export class NpcGameRoomState extends Schema implements serverStateSpec.NpcGameRoomState {
